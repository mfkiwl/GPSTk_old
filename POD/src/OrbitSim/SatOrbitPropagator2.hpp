...
namespace POD
{
   ...
   public:
      ...
      { pIntegrator->setStepSize(step_size); return (*this); }
          ...
          * @return       
          */
      SatOrbitPropagator2& setInitState(UTCTime utc0, Vector<double> rv0);
   ...
   }; // End of class 'SatOrbitPropagator2'
